 ...
 * @version 1.0
 */
public class BeqI extends GenericBranchI {
     ...
     * comparison of equality between the input and a constant. Depending on the
     * result of the comparison, the "IF" output or the "ELSE" output will
     ...
     * parameter is equal to the constraint or "0" if they are different.
     */
    @Override
